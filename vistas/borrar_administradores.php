<?php
	...
	if(isset($_POST['id']) && $_POST['id'] > 0 && isset($_POST['boton']) && $_POST['boton'] == "borrar"){
			...
			$existe = $objAdministrador->cargar($id);
			if($existe){

				$respuesta = $objAdministrador->borrar();
...
<form method="POST" action="sistema.php?r=borrar_administradores">
	<div class="row">
	...
	?>		
			<div class=" valign-wrapper red lighten-4 col s6 offset-s3" style="height: 100px; font-size:25px">
				...
				<a href="sistema.php?r=listar_administradores" class="btn red lighten-2">Regresar</a>
			</div>
	<?php
		}else{
	?>
