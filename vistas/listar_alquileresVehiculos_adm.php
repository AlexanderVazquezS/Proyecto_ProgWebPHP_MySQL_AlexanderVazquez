...
<table class="striped">
    <thead>
        <tr>
            <th colspan="11">
                <a href="sistema.php?r=layout" class="btn red right">
...
<?php  foreach($listaAlquiler as $alquiler){ ?>
        ...
        <tr>            
            ...
            <td>
                <a href="sistema.php?r=ingresar_alquiler_adm&id=<?=$alquiler['id']?>" class="btn btn-floating Green">
                    <i class="material-icons">add</i>
                </a>
  <?php
			if (isset($_SESSION['tipo_usuario']) && $_SESSION['tipo_usuario'] != "vendedor") {
?>
                <a href="sistema.php?r=editar_alquiler_adm&id=<?=$alquiler['id']?>" class="btn btn-floating blue lighten-2">
                    <i class="material-icons">edit</i>
                </a>
                <a href="sistema.php?r=borrar_alquiler_adm&id=<?=$alquiler['id']?>" class="btn btn-floating red">
            ...
            <td class="blue lighten-2" colspan="11">
                <ul class="pagination center-align">
                    <li class="waves-effect">
                        <a href="sistema.php?r=listar_alquileresVehiculos_adm&pagina=1">
                            <i class="material-icons">fast_rewind</i>
                        </a>
                    </li>
                    <li class="waves-effect">
                        <a href="sistema.php?r=listar_alquileresVehiculos_adm&pagina=<?=$paginaAnterior?>">
...
?>
                    <li class="<?=$color?>">
                        <a href="sistema.php?r=listar_alquileresVehiculos_adm&pagina=<?=$i?>"><?=$i?></a>
                    </li>
<?php
                    }
?>
                    ...
                    <li class="waves-effect">
                        <a href="sistema.php?r=listar_alquileresVehiculos_adm&pagina=<?=$paginaSiguente?>">
                            <i class="material-icons">chevron_right</i>
                        </a>
                    </li>
                    <li class="waves-effect">
                        <a href="sistema.php?r=listar_alquileresVehiculos_adm&pagina=<?=$totalPagina?>">
